...
execute as @s[advancements={blazeandcave:statistics/did_you_just_run_across_earth=true}] run function bc_rewards:trophy/statistics/did_you_just_run_across_earth
