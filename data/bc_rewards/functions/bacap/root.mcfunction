...
execute if score intro_msg bac_settings matches 1 run tellraw @s {"color":"white","italic":"false","translate":" Over ","extra":[{"text":"850"},{"translate":" brand new advancements in your Minecraft world!"}]}
