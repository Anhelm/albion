...
execute as @a[advancements={blazeandcave:farming/foilage=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={blazeandcave:mining/filthy_lich=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={blazeandcave:adventure/this_dirt_is_dirtier=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:adventure/leaflet_drop=true}] run scoreboard players add @s bac_advancements 1
